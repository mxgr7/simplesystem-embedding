...
class EvaluationCliTests(unittest.TestCase):
    ...
    def test_reports_ndcg_delta_for_binary_precision(
        ...
        self.assertTrue(math.isclose(report["metrics"]["exact_success@1"], 0.0))
        self.assertTrue(math.isclose(report["metrics"]["exact_mrr"], 0.5))
        self.assertTrue(math.isclose(report["metrics"]["exact_recall@5"], 1.0))
        self.assertTrue(math.isclose(report["metrics"]["exact_recall@10"], 1.0))
        ...
        self.assertTrue(
            math.isclose(report["baseline_metrics"]["exact_success@1"], 1.0)
        )
        self.assertTrue(math.isclose(report["baseline_metrics"]["exact_mrr"], 1.0))
        self.assertTrue(math.isclose(report["metric_deltas"]["exact_success@1"], -1.0))
        self.assertTrue(math.isclose(report["metric_deltas"]["exact_mrr"], -0.5))
